...
- **Facebook 帖子 (1200x630)**：1.91:1 宽高比，Facebook 推荐尺寸`
    ...
    useCases: [
      { title: "社交媒体发布", description: "调整图片到各平台推荐尺寸，确保最佳展示效果和加载速度" },
      { title: "网站优化", description: "缩小图片尺寸以减少文件大小，提升网页加载速度和 SEO 排名" },
      { title: "电商产品图", description: "统一产品图片尺寸，打造专业的店铺形象和一致的视觉体验" },
      { title: "打印输出", description: "调整图片分辨率和尺寸到打印要求，确保打印质量和尺寸准确" },
      { title: "头像制作", description: "将照片调整为标准头像尺寸，用于社交媒体、论坛、工作系统等" },
      { title: "壁纸定制", description: "根据设备屏幕分辨率调整图片，制作个性化的手机或电脑壁纸" }
    ],
    tips: [
    ...
    faq: [
      {
        question: "调整尺寸会损失画质吗？",
        answer: "缩小图片通常不会明显损失画质，现代插值算法能很好地保留细节。放大图片会导致一定程度的模糊，因为算法需要"猜测"新像素的颜色。建议放大不超过原图的 200%，并通过提高输出质量参数来补偿。"
      },
      {
        question: "如何保持原始宽高比？",
        answer: "勾选"保持宽高比"选项后，修改宽度或高度时会自动计算另一个值以保持比例。这是避免图片变形的最佳实践，除非您需要进行自由裁剪或特殊比例调整。"
      },
      {
        question: "支持哪些预设尺寸？",
        answer: "我们提供常用预设：Full HD (1920x1080)、HD (1280x720)、Instagram 方形 (1080x1080)、Instagram 竖版 (1080x1350)、Twitter 帖子 (1200x675)、Facebook 帖子 (1200x630) 等主流社交媒体尺寸。"
      },
      {
        question: "图片会上传到服务器吗？",
        answer: "绝对不会。所有调整操作都在您的浏览器本地完成，图片数据不会离开您的设备。这是我们的核心隐私保护特性，确保您的图片 100% 安全。"
      },
      {
        question: "可以调整图片的 DPI 吗？",
        answer: "DPI（每英寸点数）主要用于打印。我们的工具调整的是像素尺寸，打印时会根据 DPI 自动计算实际尺寸。如需特定打印尺寸，建议同时考虑像素尺寸和目标 DPI。"
      },
      {
        question: "为什么放大后的图片变模糊了？",
        answer: "放大图片需要创建新的像素，这些像素的颜色是通过插值算法"猜测"的，无法创造原图中不存在的细节。这是数字图像处理的固有局限。建议尽量使用等于或大于目标尺寸的源图片。"
      },
      {
        question: "支持批量调整吗？",
        answer: "是的，工具支持同时上传和调整多张图片。您可以一次选择所有需要调整的图片，工具会依次处理并提供单独下载。批量调整可以大幅提高工作效率。"
      },
      {
        question: "调整后的图片可以用于商业用途吗？",
        answer: "可以。您拥有调整后图片的完全使用权，我们不会添加任何水印或限制。无论是个人使用还是商业用途，都可以自由使用。"
      }
    ]
  } : {
    whyChooseSection: {
...
- **Facebook Post (1200x630)**: 1.91:1 aspect ratio, Facebook recommended size`
    ...
    useCases: [
      { title: "Social Media Posting", description: "Resize images to platform-recommended dimensions for optimal display and loading speed" },
      { title: "Website Optimization", description: "Reduce image dimensions to decrease file size, improve page loading speed and SEO rankings" },
      { title: "E-commerce Product Images", description: "Unify product image sizes for professional store appearance and consistent visual experience" },
      { title: "Print Output", description: "Adjust image resolution and size to print requirements for accurate quality and dimensions" },
      { title: "Avatar Creation", description: "Resize photos to standard avatar sizes for social media, forums, work systems, etc." },
      { title: "Wallpaper Customization", description: "Adjust images to device screen resolutions for personalized phone or computer wallpapers" }
    ],
    tips: [
    ...
    faq: [
      {
        ...
        answer: "Reducing image size typically doesn't noticeably affect quality - modern interpolation algorithms preserve details well. Enlarging images causes some blurriness as the algorithm needs to 'guess' new pixel colors. Recommend enlarging no more than 200% of original size, and compensate by increasing output quality parameters."
      },
      {
        question: "How to maintain original aspect ratio?",
        answer: "After checking the 'Maintain aspect ratio' option, modifying width or height will automatically calculate the other value to maintain proportions. This is best practice to avoid distortion, unless you need free cropping or special ratio adjustments."
      },
      {
        question: "What preset sizes are available?",
        answer: "We provide common presets: Full HD (1920x1080), HD (1280x720), Instagram Square (1080x1080), Instagram Portrait (1080x1350), Twitter Post (1200x675), Facebook Post (1200x630), and other mainstream social media sizes."
      },
      {
        question: "Are images uploaded to your servers?",
        answer: "Absolutely not. All resizing operations happen locally in your browser - image data never leaves your device. This is our core privacy protection feature, ensuring 100% security of your images."
      },
      {
        question: "Can I adjust image DPI?",
        answer: "DPI (dots per inch) is primarily for printing. Our tool adjusts pixel dimensions, which will automatically calculate actual print size based on DPI. For specific print sizes, consider both pixel dimensions and target DPI."
      },
      {
        question: "Why does my enlarged image look blurry?",
        answer: "Enlarging images requires creating new pixels whose colors are 'guessed' by interpolation algorithms - they cannot create details that don't exist in the original. This is an inherent limitation of digital image processing. Recommend using source images equal to or larger than target size."
      },
      {
        question: "Do you support batch resizing?",
        answer: "Yes, the tool supports uploading and resizing multiple images simultaneously. You can select all images needing adjustment at once, and the tool will process them sequentially with individual downloads. Batch resizing greatly improves work efficiency."
      },
      {
        question: "Can resized images be used commercially?",
        answer: "Yes. You have full usage rights to resized images. We don't add any watermarks or restrictions. Free to use for both personal and commercial purposes."
      }
    ]
  };
  ...
  return (
    <ToolLayout
      ...
      howToSteps={
        params.locale === "zh"
          ? ["点击上传区域或拖拽图片到页面，支持 JPG、PNG、WebP 等格式", "选择调整模式：指定尺寸（输入宽高）、百分比（缩放比例）或预设尺寸", "设置目标尺寸或缩放比例，可选择是否保持原始宽高比", "点击「开始调整」按钮，浏览器将在本地执行调整操作", "预览调整效果，满意后点击下载保存到新设备"]
          : ["Click the upload area or drag and drop images onto the page, supports JPG, PNG, WebP and more", "Choose resize mode: Dimensions (input width/height), Percentage (scale), or Preset size", "Set target dimensions or scale percentage, optionally maintain original aspect ratio", "Click the 'Start Resizing' button - your browser will perform the resizing locally", "Preview the resized image and click download to save to your device"]
      }
      howToDetail={
        params.locale === "zh"
